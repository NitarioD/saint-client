...
import { Space, Dropdown, message, Button, Input } from "antd";
import { DownOutlined, DeleteOutlined, EditOutlined } from "@ant-design/icons";

import Tags from "./tags";
const { TextArea } = Input;

const EditVideos = ({ itemToBeEdited, videoInfo, setVideoInfo }) => {
  //local states
  ...
  //update default content to display on edit click
  useEffect(() => {
    setVideoInfo({
      _id: itemToBeEdited._id,
      title: itemToBeEdited.title,
      link: itemToBeEdited.embedlink,
      tag: itemToBeEdited.tag._id,
      description: itemToBeEdited.description,
    });
  }, [itemToBeEdited, setVideoInfo]);
            ...
            >
              <p>
                ...
                >
                  ...
                  {/* {tags.map((tag) => console.log(tag._id, videoInfo.tag._id))} */}
                </span>
              </p>
              <Dropdown
                menu={{
